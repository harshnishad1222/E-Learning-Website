  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-8">
      <div className="my-3">
        ...
        className="text-center text-3xl font-extrabold bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent drop-shadow-md "
      >
          Showing results for "<span className="text-black font-bold italic dark:text-white">{query}</span>"
      </motion.h1>
